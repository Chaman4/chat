...
CREATE TABLE `mensaje` (
  ...
  KEY `id_chat` (`id_chat`),
  CONSTRAINT `mensaje_ibfk_1` FOREIGN KEY (`id_chat`) REFERENCES `chat` (`id_chat`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'Lucario69'),(2,'Lucario 69'),(3,'Dory'),(4,'sdfsfsd'),(5,'Holaaaaaaaaaaaaa'),(6,'fdsfsdf'),(7,'Holaaa'),(8,'wdssfds'),(9,'retetrete'),(10,'Lucario');
...
-- Dump completed on 2018-10-31 20:05:48
